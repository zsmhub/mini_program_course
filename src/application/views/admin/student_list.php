...
<div data-options="region: 'center', border: false">
    ...
    <div id="toolbar">
        <?php if(user_auth('course', 'export_teacher', 'admin') == 1): ?>
            <a href='javascript:void(0)' class="easyui-linkbutton" iconCls="icon-download" plain="true" id="toolbar_download">导出学生</a>
        <?php endif; ?>
    </div>
</div>
...
<script>
    ...
    $(function() {
        var opts = {
            ...
            columns: [[
                {field: 'nickname', title: '学生姓名', width: 100, align: 'center', sortable: 'true'},
                ...
                {field: 'score', title: '上课获得学分', width: 100, align: 'center', sortable: 'true'},
                {field: 'apply_time', title: '报名时间', width: 100, align: 'center', sortable: 'true'},
                {field: 'sign_time', title: '签到时间', width: 100, align: 'center', sortable: 'true'}
            ]],
            toolbar: '#toolbar'
        };
